// Modulo de ventas con soporte de ventas abiertas
...
var POS = (function () {
  ...
  function renderProductGrid() {
    ...
    el.innerHTML = list.map(function (p) {
      ...
      var imageHtml = p.image
        ...
        : '';
      return '<div class="product-tile' + (noStock ? ' no-stock' : '') + '" data-id="' + p.id + '">'
        + imageHtml
        + '<div class="pt-body">'
  ...
  function updateActionButtonsVisibility() {
    var cart = State.getCart();
    var hasItems = cart && cart.length > 0;
  ...
  function confirmSale() {
    ...
    document.getElementById('conf-detail-text').innerHTML  = 'Venta <strong>' + sale.id + '</strong> &nbsp;&middot;&nbsp; ' + UI.labelMethod(sale.paymentMethod);
